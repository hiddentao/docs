...
The `routes` entry above is required in order to ensure all requests are handled using the contents of the published subfolder. The [Routes documentation](https://zeit.co/docs/v2/deployments/routes/) has more information on routing configuration.

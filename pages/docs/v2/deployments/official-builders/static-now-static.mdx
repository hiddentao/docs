...
You can also publish a subfolder of your project folder statically. Let's say you have your built output in a subfolder called `public`. You can pubish it using:
